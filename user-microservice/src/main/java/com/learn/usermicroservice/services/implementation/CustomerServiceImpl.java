...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerServiceImpl(CustomerRepository customerRepository, ApplicationUserRepository applicationUserRepository,
                               BCryptPasswordEncoder bCryptPasswordEncoder, UserRoleRepository userRoleRepository, JwtServiceImpl jwtService, TokenBlackListServiceImpl tokenBlackListService) {
